...
public class AccessoryAglet extends Item {

	public AccessoryAglet() {
		super(new Item.Properties().group(GROUP_ACCESSORY));
		this.setRegistryName(MOD_ID, "accessory_aglet");
	}
		...
		return CapCurioItem.createProvider(new ICurio() {
			...
			public void onCurioTick(String identifier, int index, LivingEntity livingEntity) {
				...
				if (!livingEntity.getEntityWorld().isRemote && livingEntity.ticksExisted % 80 == 0)
					livingEntity.addPotionEffect(new EffectInstance(Effects.SPEED, 90, 0, true, false));
